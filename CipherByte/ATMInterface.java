...
class ATM {
    ...
    public void run() {
        ...
        Account userAccount = new Account(userId, 1000); // Replace with actual account retrieval logic
            ...
            do {
                ...
                switch (choice) {
                    ...
                    case 4:
                        ...
                        Account recipientAccount = new Account(recipientId, 0); // Replace with actual account retrieval logic
...
public class ATMInterface {
    public static void main(String[] args) {
        Account sampleAccount = new Account(123456, 2000); // Replace with actual account creation logic
